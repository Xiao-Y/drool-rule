...
public class FixedSectionParam {
     ...
     * @return: null
     **/
    public FixedSectionParam(String commissionType, String houseType, BigDecimal salesAmount,
                             BigDecimal amount) {
     ...
     * @return: null
     **/
    public FixedSectionParam(String commissionType, String houseType, Integer salesNum,
                             BigDecimal amount) {
